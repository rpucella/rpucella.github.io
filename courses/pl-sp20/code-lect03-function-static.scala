 ...
 *
 * Functions as values via letfun (dynamic binding)
 *
 */
...
class VFunction1 (val param1 : String, val body : Exp) extends Value {
  ...
  override def toString () : String =
    "VFunction1(" + param1 + ", " + body.toString() + ")"
...
class VFunction2 (val param1 : String, val param2 : String, val body : Exp) extends Value {
  ...
  override def toString () : String =
    "VFunction2(" + param1 + ", " + param2 + ", " + body.toString() + ")"
...
class ELetFun2 (val fn : String, val param1 : String, val param2 : String, val fbody : Exp, val ebody : Exp) extends Exp {
  ...
  def eval (env : Env) : Value = {
    val vfn = new VFunction2(param1, param2, fbody)
    val new_env = env.push(fn, vfn)
    return ebody.eval(new_env)
  }
}
